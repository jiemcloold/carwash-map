            ...
            sortedShops.forEach((shop, index) => {
                ...
                const infoWindow = new BMap.InfoWindow(
                    \`<div style="padding:10px;">
                        ...
                        <button onclick="verifyLocation(\${shop.lat}, \${shop.lng}, '\${shop.name.replace(/'/g, "\\\\'")}', '\${shop.address.replace(/'/g, "\\\\'")}\')" style="width:100%;margin-top:10px;padding:8px;background:#FF9800;color:white;border:none;border-radius:6px;font-size:13px;font-weight:500;">🔍 核实位置</button>
